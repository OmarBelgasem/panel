...
<div class="lg:flex mt-12">
            <div class="lg:w-1/2 xl:max-w-screen-sm bg-white pb-12">
                    <div class="cursor-pointer flex items-center mt-12">
                </div>
                <div class="mt-10 px-12 sm:px-24 md:px-48 lg:px-12 xl:px-24 xl:max-w-2xl">
                    <h2 class="text-center text-4xl text-blue-blue font-display font-semibold lg:text-left xl:text-5xl
                    ...
                    <div class="mt-12">
                        ...
                        <div class="mb-12">
                            ...
                            <div class="mt-2">
                                <input id="email" type="email" class="w-full rounded outline-none focus:border focus:ring @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
                        ...
                        <div class="mb-12">
                            ...
                            <div class="mt-2">
                                <input id="password" type="password" class="w-full rounded outline-none focus:border focus:ring @error('password') is-invalid @enderror" name="password" required autocomplete="current-password">
                        ...
                        <div class="form-group row">
                            <div class="col-md-6 offset-md-4">
                                <div class="form-check">
                                    ...
                                    <label class="text-gray-gray" for="remember">
                                        {{ __('Remember Me') }}
                                    </label>
                                </div>
                            </div>
                        ...
                        <div class="">
                            <div class="mt-12">
                                <button type="submit" class="button mr-12">
                                    {{ __('Login') }}
                                </button>

                                @if (Route::has('password.request'))
                                    <a class="text-gray-gray" href="{{ route('password.request') }}">
                        ...
                        <div class="mt-12 text-sm font-display font-semibold text-gray-gray text-center">
                            Don't have an account ? <a href="/register" class="cursor-pointer text-indigo-600 hover:text-indigo-800">Sign up</a>
                        </div>
                    </div>
                </div>
            </div>
